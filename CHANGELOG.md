...
<ul><li>Fin Easter egg Gif temporaire GTA VI.</li></ul>
...
<details>
  ...
  <ul><li>🖼️ GTA VI (Switch mauvais ratio source).</li></ul>
</details>

## [8.5.7] (29/05/2026)

<ul><li>8.5.7 / 8.5.6 : Léger clean de la syntaxe.</li></ul>
<details>
  <summary><sub>Déplier</sub></summary>
...
<ul><li>Clean observer and code.</li></ul>
<details>
  <summary><sub>Déplier</sub></summary>
...
<ul><li>8.3.8 / 8.3.7 : Light Clean Html et Commentaires. / 8.3.9 : Class for switch bouton.</li></ul>
...
<ul><li>Documentation sur la partie et la source du CSS ajoutée <b>ou non</b> (Faciliter la reprise).</li></ul>
...
<ul><li><b>Bouton pour remonter les blablas comme en 2020</b> / 7.2.2 : Clean code.</li></ul>
<details>
  <summary><sub>Déplier</sub></summary>
...
<ul><li>Optimisation selecteurs CSS (changement minime).</li></ul>
...
<ul><li>Retour sur l'ancienne icone du script (JVC) Allegement de cloudflare (normalement c'est bon)</li></ul>
...
<ul><li>Correction bug bouton genesis</li></ul>
